/*
  web/src/components/ImportExport.tsx
  Ensure imports write to inventory/{cityKey} and notify UI to refresh.
  Replace getSelectedCityKey with your actual selector/hook that returns the DB city key.
*/
